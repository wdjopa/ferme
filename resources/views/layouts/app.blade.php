...
<head>
    ...
    @yield("newcss")
    <title>Gestionnaire Elevage</title>
</head>
    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="index.html">Elevage</a>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <h5 class="mb-0 text-white nav-user-name">{{ ucfirst(Auth::user()->name) }}</h5>
                                    <span class="status"></span><span class="ml-2">{{ ucfirst(Auth::user()->email) }}</span>
                                </div>
                                <a class="dropdown-item" href="#"><i class="fas fa-user mr-2"></i>Mon Compte</a>
                                {{-- <a class="dropdown-item" href="#"><i class="fas fa-cog mr-2"></i>Setting</a> --}}
                            <a class="dropdown-item" href="{{route("logout")}}"><i class="fas fa-power-off mr-2"></i>Déconnexion</a>
                            </div>
                        </li>
                    </ul>
                </div>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                             Copyright © 2018 Elevage. All rights reserved. Dashboard by <a href="https://djopa.fr/">Wiflried Djopa</a>.
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
