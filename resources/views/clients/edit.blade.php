                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route("clients.index")}}"
                                class="breadcrumb-link">clients</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Modification de clients</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route("clients.update", $client)}}" id="validationform" class="needs-validation"
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-8">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" required="" value="{{$client->nom}}" name="nom"
                                            placeholder="Entrez le nom ou la marque du client" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Prénom</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text"value="{{$client->prenom}}" name="prenom" placeholder="Entrez le prenom du client"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text"value="{{$client->adresse}}" name="localisation"
                                            placeholder="Entrez l'adresse de localisation du client"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="email"value="{{$client->email}}" name="email" placeholder="Entrez l'adresse email"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Téléphone
                                        portable</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="tel"value="{{$client->tel}}" class="form-control phone-inputmask" name="tel"
