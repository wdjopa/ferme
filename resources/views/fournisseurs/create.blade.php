            ...
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route("fournisseurs.index")}}" class="breadcrumb-link">Fournisseurs</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Ajout de fournisseurs</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="ecommerce-widget">
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Ajout d'un nouveau fournisseur</h5>
                <div class="card-body">
                    <form method="post" action="{{route("fournisseurs.store")}}" id="validationform"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text"name="localisation"
                                            placeholder="Entrez la localisation" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
