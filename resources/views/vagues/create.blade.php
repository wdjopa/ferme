                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route("users.index")}}" class="breadcrumb-link">Gestion
                                des employés</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Créer un nouvel employé</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="ecommerce-widget">
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <h5 class="card-header">Création d'un nouvel employé</h5>
                <div class="card-body">
                    <form method="post" action="{{route("users.store")}}" id="validationform" class="needs-validation"
                            ...
                            <div class="col-sm-12 col-md-8">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-sm-6 col-lg-6">
                                                <input type="text" name="prenom" placeholder="Entrez les prénoms complets"
                                                class="form-control">
                                            </div>
                                            <div class="col-6 col-sm-6 col-lg-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Téléphone
                                        portable</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="tel" class="form-control phone-inputmask" name="tel" required
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input type="text" required="" name="cni" placeholder="Entrez le numéro de CNI"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-12 col-sm-3 col-form-label text-sm-right">Date de
                                        naissance</label>
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <input required name="datenaissance" type="datetime-local"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-12 col-sm-8 col-lg-6">
                                        <textarea name="notes" placeholder="Entrez une note sur l'employé"
                                            class="form-control"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row text-right">
                                    <div class="col col-sm-10 col-lg-9 offset-sm-1 offset-lg-0">
                                        <a href="{{route("users.index")}}"class="btn btn-space btn-secondary">Annuler</a>
